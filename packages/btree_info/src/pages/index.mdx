---
title: "Beekeeping Management Software & Digital Hive Records"
seoTitle: "b.tree | Beekeeping Software & Digital Hive Records"
description: "b.tree is beekeeping management software for digital hive records, apiary teams, organic beekeepers, migratory beekeeping, queen rearing, NFC tag scanning on Android, and AI-assisted data entry."
...
### b.tree Beekeeping Software - proudly serving since 2014

b.tree is cloud-based **beekeeping management software** and a **digital hive record** system for professional apiaries, organic beekeepers, migratory beekeepers, and apiary teams. Manage apiaries, colonies, inspections, treatments, feedings, honey harvests, tasks, queens, and queen rearing workflows in one web app.

Looking for an efficient way to manage your beekeeping tasks? Our beekeeping web application offers a quick and easy overview of your apiaries and colonies. With our app, you can keep track of your feedings, harvests, treatments, checkups, and more.

Our application allows you to customize your beekeeping methods and edit options based on your needs. With an interactive dashboard calendar, you can easily keep track of past and upcoming beekeeping events. We also offer premium features, such as satellite images and weather overlays for apiary maps, as well as the option to export data as CSV or generate a full database backup. Premium users can also access the API which allows them to export iCal events and have access to helpful and responsive statistic in our beekeeping app. See the [feature overview](/features/) for details.
...
With NFC tag scanning, Android users can connect physical hives with their digital records and work faster at the apiary. This feature depends on Android device and browser support for Web NFC.

### AI Agent Integration

Connect your favourite AI assistant — **Claude**, **ChatGPT**, or any **LLM agent** — directly to your b.tree beekeeping data. Our [Agent API](/doc-agent) lets AI bots manage hives, log inspections, create feeding plans, and query statistics through a secure, rate-limited endpoint with **OpenAPI discovery**. Generate an API key, hand it to your agent, and let AI handle the data entry while you focus on your bees. Compatible with Claude Desktop, ChatGPT custom actions, MCP agents, and any tool that supports HTTP function calling.

You can also use our ready-made **b.tree Beekeeping Manager custom GPT** for ChatGPT. It connects to b.tree through OAuth, so you can authorize access without copying API keys: [English custom GPT](https://chatgpt.com/g/g-6a07eef786548191a55f6487827f9e5a-b-tree-beekeeping-manager-en) or [German custom GPT](https://chatgpt.com/g/g-6a2bcc6afba881918b2d6f35d920d7c2-b-tree-imkerei-manager-de).

**Note:** The custom GPT currently works only with the EU server. The US server does not yet support custom GPT access.
